...
const OrderViewFacebook = () => {
  ...
  const {
    ...
    queryKey: ["fetchViewServerFB"],
    queryFn: () => getDataServer("/server_view_facebook"),
  });
  return (
    <>
      <Breadcrumb
        ...
        <div className="container">
          <Row>
            <Col xs={24} sm={24} md={17} lg={17} xl={17} span={17}>
              ...
              <Form style={{ width: "90%" }}>
                <Form.Item label="Nhập Link Hoặc ID Video: ">
                ...
                <div style={{ padding: "20px" }} className="container">
                  ...
                  <div className="container">
                    ...
                    <p style={{ textAlign: "justify", fontWeight: "bold" }}>
                      ...
                      view tối thiểu mỗi lần mua là 100 view
                    </p>
                    <p style={{ textAlign: "justify", fontWeight: "bold" }}>
...
export default OrderViewFacebook;
