...
const OrderEyeFacebook = () => {
  ...
  const {
    ...
    queryKey: ["fetchEyeServerFB"],
    queryFn: () => getDataServer("/server_eye_facebook"),
  });
...
export default OrderEyeFacebook;
