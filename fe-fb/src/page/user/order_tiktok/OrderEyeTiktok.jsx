...
import { Form, Input, Radio, Space, Breadcrumb, theme } from "antd";
import { useQuery } from "@tanstack/react-query";
import { getDataServer } from "../../../api/customer/server";
const { TextArea } = Input;
const OrderEyeTiktok = () => {
  const {
  ...
  const {
    ...
    queryKey: ["fetchEyeServerTT"],
    queryFn: () => getDataServer("/server_eye_tiktok"),
  });
        ...
        <div className="container">
          <Row>
            <Col xs={24} sm={24} md={17} lg={17} xl={17} span={17}>
              ...
              <Form style={{ width: "90%" }}>
                <Form.Item label="Nhập Link Profile Tiktok : ">
                ...
                <div style={{ padding: "20px" }} className="container">
                  ...
                  <div className="container">
                    ...
                    <p style={{ textAlign: "justify", fontWeight: "bold" }}>
                      ...
                      mắt tối thiểu mỗi lần mua là 50 mắt, thời gian 30 phút
                    </p>
                    <p style={{ textAlign: "justify", fontWeight: "bold" }}>
