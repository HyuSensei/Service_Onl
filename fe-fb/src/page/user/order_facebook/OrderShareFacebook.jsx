...
const OrderShareFacebook = () => {
  ...
  const {
    ...
    queryFn: () => getDataServer("/server_share_facebook"),
  });
  return (
    <>
      <Breadcrumb
                ...
                <div style={{ padding: "20px" }} className="container">
                  ...
                  <div className="container">
                    ...
                    <p style={{ textAlign: "justify", fontWeight: "bold" }}>
                      ...
                      share tối thiểu mỗi lần mua là 100 share
                    </p>
                    <p style={{ textAlign: "justify", fontWeight: "bold" }}>
...
export default OrderShareFacebook;
